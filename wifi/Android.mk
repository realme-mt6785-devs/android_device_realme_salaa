...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi@1.0-service-lazy.salaa.rc
...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi@1.0-service.salaa.xml
LOCAL_MODULE_TAGS  := optional
LOCAL_MODULE_CLASS := ETC
...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi@1.0-service-lazy.salaa
...
LOCAL_REQUIRED_MODULES := \
    android.hardware.wifi@1.0-service-lazy.salaa.rc \
    android.hardware.wifi@1.0-service.salaa.xml
